...
class DDIMScheduler(DDPMScheduler):    
    ...
    def _get_variance(self, t):
        ...
        variance = torch.sqrt(beta_prod_t_prev/beta_prod_t) * torch.sqrt(1- alpha_prod_t/alpha_prod_t_prev)
    ...
    def step(
        ...
        if self.prediction_type == 'epsilon':
            ...
            pred_epsilon = torch.sqrt(alpha_prod_t_prev) * pred_original_sample 
        else:
        ...
        pred_sample_direction =  torch.sqrt(1-alpha_prod_t_prev-torch.square(std_dev_t)) * model_output

        # TODO: 6. compute x_t without "random noise" of formula (12) from https://arxiv.org/pdf/2010.02502.pdf
        prev_sample = pred_epsilon + pred_sample_direction  
