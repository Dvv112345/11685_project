...
def load_checkpoint(unet, scheduler, vae=None, class_embedder=None, optimizer=None, epoch = 0, checkpoint_path='checkpoints/checkpoint.pth'):
...
def save_best_checkpoint(unet, scheduler, vae=None, class_embedder=None, optimizer=None, epoch=None, save_dir='checkpoints'):
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)

    # Define checkpoint file name
    checkpoint_path = os.path.join(save_dir, f'checkpoint_best.pth')
